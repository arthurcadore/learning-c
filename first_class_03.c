...
scanf("%f", &num1); // importing values and including into the variable "num1"
scanf("%f", &num2); // importing values and including into the variable "num1"

media = (mum1+num2)/2.0; // including math operation into the variable "media"

printf("media = %.0f", media); // printing the value of "media" with a sentence before
