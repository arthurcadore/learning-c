...
int main(){
	...
	int input1 = 0, retangleValueL, retangleValueC, retangleValueL1, retangleValueC1, input3, testingvalue = 0, trianglesVariable1 = 0 , sizeValue;
...
do{
	...
	for(retangleValueC1 = 1; retangleValueC1 <= retangleValueC; retangleValueC1++){

		for(retangleValueL1 = 1; retangleValueL1 <= retangleValueL; retangleValueL1++){
